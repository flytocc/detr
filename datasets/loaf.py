...
import datasets.transforms_loaf as T
...
def make_loaf_transforms(image_set):
...
def build(image_set, args):
    ...
    dataset = CocoDetection(img_folder, ann_file, transforms=make_loaf_transforms(image_set), return_masks=args.masks)
    return dataset
